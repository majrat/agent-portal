...
export default function Home() {
  ...
  const showSession = () => {
    if (status === "authenticated") {
      return (
        <div className="min-h-screen rounded-sm border text-black border-stroke bg-white/80 bg-blend-screen bg-[url('/images/home-bg-02.png')] bg-cover px-3 lg:px-6 py-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
          ...
          <h2 className="font-medium text-xl py-6">PRIORITY{"'"}S WORLD</h2>
          ...
          <div className="grid md:grid-cols-2 gap-10 place-items-center">
            <div className="relative overflow-hidden w-full h-60 text-white">
            ...
            <div className="relative overflow-hidden w-full h-60 text-white text-start">
              <div className="z-9 w-full h-60 absolute p-3 md:p-6 bg-meta-4/90">
