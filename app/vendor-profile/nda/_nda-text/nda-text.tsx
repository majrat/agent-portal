...
const NDA = () => {
  return (
    <div className="p-3 dark:text-white text-black text-center rounded-md border border-stroke bg-white shadow-default dark:border-strokedark hover:border-strokedark duration-300 ease-linear dark:hover:border-stroke">
      <div className="p-6">
        <h3 className="text-xl font-medium py-3 col-span-2">
          NON DISCLOSURE AGREEMENT
        </h3>
        <p className="pt-6 font-semibold text-start">between</p>
        <p className="pt-6 text-start">(Customer name)</p>
        ...
        <p className="pt-6 text-start text-blue-800">Preamble</p>
        <p className="pt-9 text-start">
          In this context the Parties wish to disclose to each other proprietary
          and sensitive commercial or technical information. In order to protect
          any such confidential or proprietary information, the Parties are
          concluding the following agreement. In addition, the aim of this
          agreement is to prevent the unauthorised dissemination, use or
          reproduction of documents, data and other information of Carrier which
          the contract partner has already received or will receive in future.
        </p>
        <p className="pt-9 text-start">
        ...
        <ol className="ps-6 pt-9 text-start list-decimal">
          ...
          <li className="pt-9">
            Information shall not be classed as confidential according to clause
            1, if
            <ul className="ps-3 list-disc">
              <li className="pt-3">
                the disclosing Party has given its prior written consent to its
                release;
              </li>
              <li className="pt-3">
                it was demonstrably in the public domain before being passed on
          ...
          <li className="pt-9">
            ...
            within the context of its business relationship with the disclosing
            Party and shall not disseminate it to third parties unless the
            disclosing Party has given its express prior consent to use of the
            information for other purposes in written form.
          </li>
          <li className="pt-9">
          ...
          <li className="pt-9">
            ...
            comply with the applicable legal data protection regulations and do
            not disclose information obtained from the disclosing Party’s
          ...
          <li className="pt-9">
            ...
            surrender to the disclosing Party on first demand all records, data,
            notes, and other written and printed material or electronic data in
            its possession that contains confidential information or shall
            destroy it at the disclosing Party’s request, except for one (1)
            copy which may be retained as necessary to comply with applicable
            record keeping laws and procedures.
          </li>
          <li className="pt-9">
            If any current or future provision of this agreement should be or
            become ineffective, invalid or unfeasible in whole or in part, this
            shall not affect the validity of the remaining provisions. The same
            shall apply, if a gap that requires amendment should arise after
            conclusion hereof. The Parties shall replace or amend any
            ineffective, invalid or incomplete provision by an effective
            provision that corresponds to the ineffective or invalid provision
            and the overall purpose of this agreement in its legal and economic
            content.
          </li>
          <li className="pt-9">
            The assignment of this agreement or any rights and obligations
            hereunder shall not be admissible without the prior written consent
            of the other Party.
          </li>
          <li className="pt-9">
            Any changes or additions to this agreement and other declarations of
            the contracting Parties concerning the contractual relationship
          ...
          <li className="pt-9">
            ...
            Contracts for the International Sale of Goods. Any disputes under or
            in connection with this agreement shall be subject to the exclusive
            jurisdiction of the courts of Baltimore, MD USA.
          </li>
          <li className="pt-9">
