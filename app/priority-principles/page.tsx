    ...
    if (status === "authenticated") {
      return (
        <div className="min-h-screen rounded-sm border text-black dark:text-white border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <h3 className="text-xl font-medium pt-3 pb-3">PRIORITY PRINCIPLES</h3>
          <ul className="list-disc ps-6 pb-3">
            <li className="pb-3">
              Principle One: <span className="font-bold">Compliance</span> -{" "}
              Compliance in international logistics is crucial for the seamless
              and efficient movement of goods across borders. Adhering to
              international regulations, trade agreements, and customs
              requirements ensures that our operations run smoothly and legally.
            ...
            <li className="pb-3">
              ...
              global perspective necessary for effective and responsible supply
              chain management. Embracing the humanities ensures that logistics
              professionals are not only technically proficient but also
              culturally aware and ethically grounded, ultimately leading to
              more sustainable and successful global operations.
              <ul className="list-disc mx-12">
                <li>Anti-slavery, Human Trafficking and Forced Labor Policy</li>
            ...
            <li className="pb-3">
              Principle Three: <span className="font-bold">Sustainability</span>{" "}
            ...
            <li className="pb-3">
              ...
              reputation, and maintain supply chain continuity. By prioritizing
              cargo safety and security, logistics providers can deliver
              reliable and secure services, supporting global trade and economic
              growth.
              <ul className="list-disc mx-12">
